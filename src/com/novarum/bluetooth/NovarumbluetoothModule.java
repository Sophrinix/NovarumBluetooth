...
public class NovarumbluetoothModule extends KrollModule
{
	...
	public boolean socketConnect(BluetoothDevice btDevice)
	{
		...
		{
			postError("socketConnect: " + e.getMessage());
			return false;
		}
	...
	public boolean connect(String devicemac)
	{
		...
		{		
			...
			if (bluetoothDevice.getBondState() == BluetoothDevice.BOND_NONE) 
			{
				...
				{
					postError("connect: " + "Could not pair device");
					return false;
				}
			}
			else
	...
	public boolean sendData(String data) 
	{
		...
		else
		{
			if (btsocket != null && isConnected == true) 
			{
				...
				{
					postError("sendData: " + e.getMessage());
					return false;
				}
			}
			else
			{
				postError("sendData2: " + "Not connected or data is null");
				return false;
			}
		}
	}
        ...
        public void onReceive(Context context, Intent intent) 
        {
            ...
            if(BluetoothDevice.ACTION_FOUND.equals(action))
            {
                ...
                catch (Exception e) 
                {
                    ...
                    postError("myReceiver: " + e.getMessage());
                }
		...
		public void run() 
		{
			...
			while (isConnected) 
			{
				if (inputStream != null) 
				{
					...
					{
						postError("dataReceiver:run: " + e.getMessage());
					}
				}
			}
		}
	...
	private void manageConnectedSocket()
	{
		...
		{
			postError("manageConnectedSocket: " + e.getMessage());
	...
	{	
		...
		{
			postError("startServer: " + e.getMessage());
		}
	}
	...
	private class AcceptThread extends Thread 
	{
	    ...
	    public AcceptThread() 
	    {
	        ...
	        { 
	        	postError("AcceptThread: " + e.getMessage());
	        }
	    ...
	    public void run() 
	    {
	        ...
	        while (true) 
	        {
	            ...
	            {
	            	postError("AcceptThread:run: " + e.getMessage());
	            }
	            ...
	            if (btsocket != null) 
	            {
	                ...
	                {
	                	postError("AcceptThread:run2: " + e.getMessage());
	                	// TODO Auto-generated catch block
						e.printStackTrace();
					}
	    ...
	    public void cancel() 
	    {
	        ...
	        { 
	        	postError("AcceptThread:cancel: " + e.getMessage());
	        }
	    }
	}	
